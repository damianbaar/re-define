        ...
        function(cb) {
          ...
          fs.exists(configPath, function(exists) {
            ...
            fs.readFile(configPath, function(err, fromCache) {
              ...
              // needsRevalidation = needsRevalidation || !_.isEqual(conf.wrapper, config.wrapper)
              // needsRevalidation = needsRevalidation || !_.isEqual(conf.names, config.names)
              // needsRevalidation = needsRevalidation || !_.isEqual(conf.returns, config.returns)
